...
| LSP-002 | Implement v1 `.sage` caret preprocessing and mapping | Source mapping v1 | lsp | done | MingLLuo | `.sage` preprocessing rewrites standalone carets, preserves line count, and exposes bidirectional position mapping with tests. | `docs/design/source-mapping-v1-caret.md` | pending |
