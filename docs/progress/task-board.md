...
| OPS-003 | Fix bootstrap build failures | Repository bootstrap | ops | in_progress | MingLLuo | `npm run build` completes from the repository root after initial TypeScript and wiring fixes. | `docs/developer-guide.md` | pending |
