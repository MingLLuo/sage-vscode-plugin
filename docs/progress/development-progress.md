...
- Extension package: not yet scaffolded
- Language server package: not yet scaffolded
- Syntax package: not yet scaffolded

## Current Focus

1. Land minimal package scaffolds for extension, server, and syntax assets.
2. Continue deepening design notes around source mapping and runtime boundaries.
...
| Extension scaffold | Planned | Minimal VS Code client package to be added next. |
