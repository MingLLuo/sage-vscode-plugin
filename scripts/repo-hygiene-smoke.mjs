...
pushCheck("GitHub workflow gives shared-runner index benchmarks bounded headroom", /SAGE_PERF_PARSE_MS:\s*["']3000["']/.test(workflow)
  && /SAGE_PERF_REBUILD_INTERNAL_MS:\s*["']3000["']/.test(workflow), ".github/workflows/ci.yml");
