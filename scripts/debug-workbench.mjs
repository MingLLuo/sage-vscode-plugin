...
const uxScenarios = [
  ...
  },
  {
    ...
    title: "Sage-heavy Python polynomial ring ideal recommendations",
    file: "10_sage_heavy_python.py",
    line: 87,
    character: 21,
    expects: {
      ...
      noDefinition: true,
      minDefinitionCandidates: 2,
      definitionCandidatePathIncludes: "sage/src/sage/rings/polynomial/multi_polynomial_libsingular.pyx",
      resolutionConfidence: "ambiguous",
      resolutionReasonIncludes: "explicit selection is required",
      allowFallbackReason: true,
    },
  },
  {
    ...
    title: "Sage-heavy Python ideal variety recommendations",
    file: "10_sage_heavy_python.py",
    line: 115,
    character: 17,
    expects: {
      ...
      noDefinition: true,
      minDefinitionCandidates: 2,
      definitionCandidatePathIncludes: "sage/src/sage/rings/polynomial/multi_polynomial_ideal.py",
      resolutionConfidence: "ambiguous",
      resolutionReasonIncludes: "explicit selection is required",
      allowFallbackReason: true,
    },
